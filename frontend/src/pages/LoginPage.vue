    ...
    <div class="w-full max-w-md">
      ...
      <div class="card p-8">
        ...
        <form @submit.prevent="handleLogin" class="space-y-5">
          ...
          <div>
            <div class="flex items-center justify-between mb-2">
              ...
              <RouterLink to="/forgot-password" class="text-xs text-primary-600 dark:text-primary-400 hover:underline">Forgot password?</RouterLink>
            </div>
            <div class="relative">
              <input
        ...
        <div class="relative my-6">
          ...
          <div class="relative flex justify-center text-xs text-gray-500 dark:text-gray-400"><span class="bg-white dark:bg-surface-900 px-3">or continue with</span></div>
        </div>

        <a :href="`${apiBase}/api/v1/auth/google`" class="btn-secondary w-full py-3 gap-3 flex items-center justify-center">
      ...
      <p class="text-center text-sm text-gray-600 dark:text-gray-400 mt-6">
        ...
        <RouterLink to="/register" class="link font-medium">Sign up free</RouterLink>
      </p>
    </div>
  </div>
</template>
